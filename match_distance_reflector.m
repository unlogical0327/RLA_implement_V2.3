...
function [matched_reflect_ID,matched_reflect_vec_ID,matched_detect_ID,matched_detect_vec_ID,result] = match_distance_reflector(match_dist_vector_pool,Reflect_vec_ID,detect_Ref_dist_vector,detected_vec_ID,thres_dist_large,thres_dist_match)
% NP_enable?
...
match_distance_flag(1:length(detect_Ref_dist_vector))=0;
...
if  m>=3
    ...
    result=1;
    elseif m>length(detected_vec_ID)
        result=1;
